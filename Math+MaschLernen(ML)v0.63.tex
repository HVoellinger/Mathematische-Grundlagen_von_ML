...
\begin{center}
Diese Version V0.63 (Datum: 11.9.2023) ist nicht final!!! \\
...
%
{\color{red}{*********** Restliche Berechnungen fehlen noch *********************}}\\
%
...
\subsubsection{Übung 5.2 - Berechnung von Varianzen }

Berechne die Varianzen im Car-Daten Beispiel 
\begin{table}[h]
  \centering
  \begin{tabular}{|l|r|}
  \hline
...
\subsubsection{Übung 5.3* - Vermutung (V-5.1)}
...
\subsubsection{Übung 5.4 - Berechnung eines sLR Beispiels.......}
%								
Finde eine "least square fit" gerade  y = a + b*x für y:=erreichte Punktzahl (Score) des Examens [pt.]” abhängig vom Parameter: x:="Aufwand der Examens Vorbereitung in Std.[h]" \\
Daten der Trainings-Sets TS  = $ \lbrace (x; y;) | (exam vorb.[h], homework[h]; score[pt.])\rbrace = \lbrace(7;41 ),(3;27), (5;35), (3;26), (8;48), (7;45), (10;46), (3;27), (5;29), (3;19)\rbrace $ \\
\textbf{Task:} Baue das Modell sLR(x,y). Vergleiche und prüfe das Ergebnis mit einem Python-Programm.\\[0.2cm]
\textbf{Beantworte die folgenden Fragen:}\\ 
...
Q3: Wie viel Aufwand ist notwendig um genug Punkte (=25) zum Bestehen des Examens?\

\subsubsection{Übung 5.5 - Berechnung eines mLR(k=2) Beispiels}
%
Analog zu Übung 5.4
\textbf{Berechne das  mLR(k=2)-Modell studentische Examens-Ergebnisse}\\
Analog zu Übung (5.4).  
...
Daten der Trainings-Sets TS  = $ \lbrace (x, y; z) | (exam vorb.[h], homework[h]; score[pt.])\rbrace = \lbrace(7,5;41 ),(3,4;27), (5,5;35), (3,3;26), (8,9;48), (7,8;45), (10,10;46), (3,5;27), (5,3;29), (3,3;19)\rbrace $ \\
\textbf{Task:} Baue das Modell mLR(x,y;z). Vergleiche und prüfe das Ergebnis mit einem Python-Programm.\\[0.2cm]
\textbf{Beantworte die folgenden Fragen:}\\ 
Q1: Wie viele Punkte würde ein Student ohne Examens Vorbereitung und ohne Hausaufgabe Aufwand erreichen? \\
...
Q3: Wie viel Aufwand ist notwendig um genug Punkte (=25) zum Bestehen des Examens?\\ 
\textbf{Zusätzliche Frage/Anmerkung:} Unsere Berechnung nutzt beide Variablen zur Berechnung. Was ist der Unterschied zum sLR-Model Resultat? Vergleiche Adj.R² (wie hier genutzt) zu zwei R²- Lösungen (E5.1).\\
...
%
\hspace*{-0.1cm} Weitere Hilfe unter \textbf{[HVö-5]:}\\
...
%
$\rightarrow$ opt. Regression-Gerade:  y =  14,117 + 3,7376*x \\
$\rightarrow$ R² = 1 - Sum((yi-y(xi))²)/Sum((yi-M(y))²) = 1 -(134,2172/922,1) $\backsim $ 0,8544 \\[0.2cm]	
%				
Question 1:   14,117 points.	\\				
Question 2:   14,117 + 37,38 = 51,497 = 50 points (grade=  1,0).\\					
Question 3:  x= (25-14,117)/3,7376=2,91[h] 	\\[0.4cm]							
%
...
%
$\rightarrow$ opt. mLR-Ebene :  z = 13,264 +  2,488*x +  1,382*y		\\					
$\rightarrow$ Adj.R²=  1 -(1-R²)*(9/7) $\backsim $ 0.8512  \\[0.4cm]				%	
Für eine komplette Lösung vergleiche:\\
\url{https://github.com/HVoellinger/Lecture-Notes-to-ML-WS2020/blob/master/LR-Calculation_of_Coeff.xlsx}
