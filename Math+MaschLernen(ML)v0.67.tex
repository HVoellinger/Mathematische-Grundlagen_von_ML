...
\end{equation}
Diese Gleichung nennt man {\color{blue}{Normalform}}.  \index{normal equation}\. Nutzen wir die Gleichungen (A') so können wir jetzt leicht per Matrizen-Multiplikation die Komponenten der (kxk)-Produktmatrix $ X^\top \cdot X $ berechnen:
\\[0.3cm]
\hspace*{2.0cm}
$ X^\top \cdot X := \left(
  \begin{array}{c}
