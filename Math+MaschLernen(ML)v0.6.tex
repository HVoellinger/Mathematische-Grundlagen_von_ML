...
\begin{center}
Diese Version ist nicht final !!! (Beachte: ****** Kommentare ******). Aktuelle Versionen findet man in meinem GitHub:\\\url{https://github.com/HVoellinger/Mathematische-Grundlagen_von_ML/blob/main/Math%2BMaschLernen(ML)v0.6.pdf} \\
\vspace{0.2cm}
...
\subsection{DT-Verfahren mit Gini-Index- oder Entropie-Verfahren}
...
\subsection{Beispiele für GINI-Verfahren}
...
\subsubsection{Beispiele für Entropie-Verfahren}
...
\subsubsection{Übung 3.4}


\subsubsection{Übung 3.5}
...
\subsubsection{Übung 5.1 - Bsp. einer Bayes-Texklassifikation}
...
\subsubsection{Übung 5.2 - Bayes-Textklassifikation in Python}
...
\subsubsection{Übung 6.3 - Python Code zu Hyperebenen}
